 ...
 */
final class Version20210419084715 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD id_token_id INT DEFAULT NULL, DROP id_token');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD id_token INT NOT NULL, DROP id_token_id');
    }
}
